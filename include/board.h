...
/*
 * Setup for WiFi module board.
 */

/*
 * Board identifier.
 */
#define BOARD_WiFi_module
#define BOARD_NAME                  "WiFi module"
 ...
 */
#define GPIOA_PIN0                  0
#define GPIOA_LED_LINK              1
#define GPIOA_WIFI_RESET            2
#define GPIOA_PIN3                  3
#define GPIOA_PIN4                  4
#define GPIOA_PIN5                  5
#define GPIOA_PIN6                  6
#define GPIOA_PIN7                  7
#define GPIOA_WIFI_IRQ              8
#define GPIOA_WIFI_WAKE             9
...
#define GPIOB_WIFI_EN               11
#define GPIOB_WIFI_CS               12
...
#define CONF_WINC_PIN_WAKE          PAL_LINE(GPIOA, GPIOA_WIFI_WAKE)
#define CONF_WINC_PIN_CHIP_ENABLE   PAL_LINE(GPIOB, GPIOB_WIFI_EN)
#define CONF_WINC_PIN_RESET         PAL_LINE(GPIOA, GPIOA_WIFI_RESET)
#define CONF_WINC_PIN_CS            PAL_LINE(GPIOB, GPIOB_WIFI_CS)
/*
 ...
 * PA1  - LED_LINK                  (output pushpull maximum).
 * PA2  - WIFI_RESET                (output pushpull maximum).
 * PA3  - PIN3                      (input pullup).
 * PA4  - PIN4                      (input pullup).
 * PA5  - PIN5                      (input pullup).
 * PA6  - PIN6                      (input pullup).
 * PA7  - PIN7                      (input pullup).
 * PA8  - WIFI_IRQ                  (input pullup).
 * PA9  - WIFI_WAKE                 (output pushpull maximum).
...
#define VAL_GPIOA_MODER             (PIN_MODE_INPUT(GPIOA_PIN0) |           \
                                     PIN_MODE_OUTPUT(GPIOA_LED_LINK) |      \
                                     PIN_MODE_OUTPUT(GPIOA_WIFI_RESET) |    \
                                     PIN_MODE_INPUT(GPIOA_PIN3) |           \
                                     PIN_MODE_INPUT(GPIOA_PIN4) |           \
                                     PIN_MODE_INPUT(GPIOA_PIN5) |           \
                                     PIN_MODE_INPUT(GPIOA_PIN6) |           \
                                     PIN_MODE_INPUT(GPIOA_PIN7) |           \
                                     PIN_MODE_INPUT(GPIOA_WIFI_IRQ) |       \
                                     PIN_MODE_OUTPUT(GPIOA_WIFI_WAKE) |     \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_PIN0) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_LED_LINK) |   \
                                     PIN_OTYPE_PUSHPULL(GPIOA_WIFI_RESET) | \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN3) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN4) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN5) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN6) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN7) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_WIFI_IRQ) |   \
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_2M(GPIOA_PIN0) |            \
                                     PIN_OSPEED_100M(GPIOA_LED_LINK) |      \
                                     PIN_OSPEED_100M(GPIOA_WIFI_RESET) |    \
                                     PIN_OSPEED_2M(GPIOA_PIN3) |            \
                                     PIN_OSPEED_2M(GPIOA_PIN4) |            \
                                     PIN_OSPEED_2M(GPIOA_PIN5) |            \
                                     PIN_OSPEED_2M(GPIOA_PIN6) |            \
                                     PIN_OSPEED_2M(GPIOA_PIN7) |            \
                                     PIN_OSPEED_100M(GPIOA_WIFI_IRQ) |      \
                                     PIN_OSPEED_100M(GPIOA_WIFI_WAKE) |     \
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_PULLUP(GPIOA_PIN0) |         \
                                     PIN_PUPDR_FLOATING(GPIOA_LED_LINK) |   \
                                     PIN_PUPDR_FLOATING(GPIOA_WIFI_RESET) | \
                                     PIN_PUPDR_PULLUP(GPIOA_PIN3) |         \
                                     PIN_PUPDR_PULLUP(GPIOA_PIN4) |         \
                                     PIN_PUPDR_PULLUP(GPIOA_PIN5) |         \
                                     PIN_PUPDR_PULLUP(GPIOA_PIN6) |         \
                                     PIN_PUPDR_PULLUP(GPIOA_PIN7) |         \
                                     PIN_PUPDR_PULLUP(GPIOA_WIFI_IRQ) |     \
...
#define VAL_GPIOA_ODR               (PIN_ODR_HIGH(GPIOA_PIN0) |             \
                                     PIN_ODR_LOW(GPIOA_LED_LINK) |          \
                                     PIN_ODR_LOW(GPIOA_WIFI_RESET) |        \
                                     PIN_ODR_HIGH(GPIOA_PIN3) |             \
                                     PIN_ODR_HIGH(GPIOA_PIN4) |             \
                                     PIN_ODR_HIGH(GPIOA_PIN5) |             \
                                     PIN_ODR_HIGH(GPIOA_PIN6) |             \
                                     PIN_ODR_HIGH(GPIOA_PIN7) |             \
                                     PIN_ODR_HIGH(GPIOA_WIFI_IRQ) |         \
                                     PIN_ODR_HIGH(GPIOA_WIFI_WAKE) |        \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_PIN0, 0) |           \
                                     PIN_AFIO_AF(GPIOA_LED_LINK, 0) |       \
                                     PIN_AFIO_AF(GPIOA_WIFI_RESET, 0) |     \
                                     PIN_AFIO_AF(GPIOA_PIN3, 0) |           \
                                     PIN_AFIO_AF(GPIOA_PIN4, 0) |           \
                                     PIN_AFIO_AF(GPIOA_PIN5, 0) |           \
                                     PIN_AFIO_AF(GPIOA_PIN6, 0) |           \
                                     PIN_AFIO_AF(GPIOA_PIN7, 0))
#define VAL_GPIOA_AFRH              (PIN_AFIO_AF(GPIOA_WIFI_IRQ, 0) |       \
                                     PIN_AFIO_AF(GPIOA_WIFI_WAKE, 0) |      \
 ...
 * PB11 - WIFI_EN                   (output pushpull maximum).
 * PB12 - WIFI_CS                   (output pushpull maximum).
...
#define VAL_GPIOB_MODER             (PIN_MODE_INPUT(GPIOB_PIN0) |           \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOB_WIFI_EN) |       \
                                     PIN_MODE_OUTPUT(GPIOB_WIFI_CS) |       \
...
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_PIN0) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_WIFI_EN) |    \
                                     PIN_OTYPE_PUSHPULL(GPIOB_WIFI_CS) |    \
...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_2M(GPIOB_PIN0) |            \
                                     ...
                                     PIN_OSPEED_100M(GPIOB_WIFI_EN) |       \
                                     PIN_OSPEED_100M(GPIOB_WIFI_CS) |       \
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_PULLUP(GPIOB_PIN0) |         \
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOB_UART_TX) |         \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN7) |         \
                                     PIN_PUPDR_FLOATING(GPIOB_CAN_RX) |     \
                                     PIN_PUPDR_FLOATING(GPIOB_CAN_TX) |     \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN10) |        \
                                     PIN_PUPDR_FLOATING(GPIOB_WIFI_EN) |    \
                                     PIN_PUPDR_FLOATING(GPIOB_WIFI_CS) |    \
...
#define VAL_GPIOB_ODR               (PIN_ODR_HIGH(GPIOB_PIN0) |             \
                                     ...
                                     PIN_ODR_LOW(GPIOB_WIFI_EN) |           \
                                     PIN_ODR_HIGH(GPIOB_WIFI_CS) |          \
...
#define VAL_GPIOB_AFRH              (PIN_AFIO_AF(GPIOB_CAN_RX, 9) |         \
                                     ...
                                     PIN_AFIO_AF(GPIOB_WIFI_EN, 0) |        \
                                     PIN_AFIO_AF(GPIOB_WIFI_CS, 0) |        \
